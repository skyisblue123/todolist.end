...
function getTodo() {
    axios.get(`${apiUrl}/todos`)
        .then(function (response) {
            ...
            let strAll = '';
            if (incompleted == '') {
                incompletePart.innerHTML = `<li class="list-group-item list-group-item-secondary w-50 mx-auto text-center text-secondary fs-4 mt-5 opacity-50 shadow-mine" style="padding:200px 0;">
